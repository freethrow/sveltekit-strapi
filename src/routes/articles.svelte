...
<div class="grid grid-cols-1 gap-5 md:grid-cols-2">
    {#each articles as article}
        <div class="shadow-lg">
            ...
            <img class=" opacity-50 hover:opacity-100 transition duration-1000 w-full" 
                src="{article.attributes.cover.data.attributes.formats.small.url}" alt="{article.attributes.cover.data.attributes.name}">
            <div class="p-5">
